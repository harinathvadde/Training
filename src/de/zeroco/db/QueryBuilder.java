...
public class QueryBuilder {
	...
	public static void main(String[] args) {
		...
		List<String> columns = new ArrayList<String>(Arrays.asList("name","age","1"));
	...
	public static String getDataQuery(String schema, String tableName, List<String> columns, String refColumn, String refData) {
		...
		return "SELECT " + (Utility.isBlank(columns)?"*":clmn) + " FROM " + GRAVE + schema + GRAVE + "." + GRAVE + tableName + GRAVE 
